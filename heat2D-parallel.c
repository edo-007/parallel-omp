...
int main(int argc, char *argv[]) {
    ...
    float elapsed, mean, sum;                    //time variables
    ...
    // allocRows(Tn, Tn1, Te);
    Tn  = allocateMatrix();/* (float**)malloc(IMAX * sizeof(float*)); */
    Tn1 = allocateMatrix();/* (float**)malloc(IMAX * sizeof(float*)); */
    Te  = allocateMatrix();/* (float**)malloc(IMAX * sizeof(float*)); */
